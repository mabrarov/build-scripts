@echo off
rem -------------------------------------
set MSVS2015_DIR=%ProgramFiles(x86)%\Microsoft Visual Studio 14.0
set PERL_DIR=C:\Program Files\Perl
set OPENSSL_SRC_DIR=%~dp0openssl-1.0.2h
set OPENSSL_INSTALL_DIR=%~dp0..\openssl-1.0.2h-x64-vs2015-static
set OPENSSL_INSTALL_LIB_DIR=%OPENSSL_INSTALL_DIR%\lib
rem -------------------------------------

echo Microsoft Visual Studio 2015 directory: %MSVS2015_DIR%
...
call "%MSVS2015_DIR%\VC\vcvarsall.bat" amd64
